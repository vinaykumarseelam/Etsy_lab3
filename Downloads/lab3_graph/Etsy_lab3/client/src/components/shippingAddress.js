...
import { selectUser, updateUserDetails } from "../../src/features/userSlice";
import {
  clearCart,
  createCartItem,
  createFinalCart,
  getCartItems,
} from "../../src/features/cartItemsSlice";
...
function shippingAddress() {
  ...
  const editShippingAddress = () => {
    Axios.put(
      `${process.env.REACT_APP_ENDPOINT}/api/users/updateUserAddress/` +
        user.id,
      {
  ...
  return (
    <div>
      <Navbar />
      <hr></hr>
      <div className="shippingAddres">
        <h2 className="title">Enter your shipping address</h2>
        <div className="shippingAddressForm">
          <div
            ...
            className="section"
          >
            <div style={{ marginBottom: "5px" }} className="label">
          ...
          <div className="section">
            ...
            >
              ...
              <option value="Daily City">Daily City</option>
              <option value="Daily Cityn Republic">Daily Cityn Republic</option>
